...
from app.src.features.process_user_prompt.ai.agents.sql_agent import (
    SQLAgent,
    SQLAgentOutput
)
from app.src.features.process_user_prompt.ai.agents.generic_data_agent import (
    GenericDataAgent,
...
# Defining a structured output for the agent
class MainAgentOutput(BaseModel):
    ...
    generic_agent_output: Optional[GenericDataAgentOutput]
    sql_agent_output: Optional[SQLAgentOutput]
